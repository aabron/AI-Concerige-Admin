...
import { typeOptions, subTypeOptions, dietaryOptions, 
    ...
    restaurantTypeOptions } from '@/pages/dashboard/arrays/Arrays';
import { DynamicFormDropdowns, DynamicFormDropdowns2, DynamicFormDropdowns3} from '../../configs/DynamicFormDropdowns';
import organizeReviewQuery from '../../configs/organizeReviewQuery';
...
const AddBusiness = ({ logout }) => {
    ...
    return (
        <>
        {!editPage ?  
        <div className='grid grid-cols-[30%_70%] max-w-full' >
            
            <div className="min-h-screen flex items-center justify-center py-9 px-1 sm:px-1 lg:px-1">
                <Modal
                    isOpen={loading}
